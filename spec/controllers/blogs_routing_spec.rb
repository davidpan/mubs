...
describe BlogsController do
  describe "route generation" do
    ...
    it "should map { :controller => 'blogs', :action => 'home' } to / 应当将blog控制器作为总的起始页，即根目录" do
      route_for(:controller => "blogs", :action => "home").should == "/"
    end
  ...
  describe "route recognition" do
    it "should generate params { :controller => 'blogs', action => 'home' } from GET /" do
      params_from(:get, "/").should == {:controller => "blogs", :action => "home"}
    end
